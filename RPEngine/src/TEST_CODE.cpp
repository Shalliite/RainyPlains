...
rpe::uint16 a_width = 0;
rpe::uint16 a_height = 0;
MSG a_msg = {};
...
extern "C" _declspec(dllexport) void CreateWnd(HWND parentHwnd, rpe::uint16 width, rpe::uint16 height)
{
	a_width = width;
	a_height = height;
...
{
	a_width = (rpe::uint16)width;
	a_height = (rpe::uint16)height;
}
